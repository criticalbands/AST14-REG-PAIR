//a gate that activates whenever a ZERO is acheived can be made by conencting a 330 ohm resistor to pin 9 and a gate on a ONE on pin 9
...
void loop() {
  ...
  val = map(val, 0, 1023, 700, 3);
  delay(val);

  randNumber = random(1, 23);
